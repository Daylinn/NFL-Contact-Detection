...
from src.detection_utils import FIELD_LENGTH, FIELD_WIDTH, find_contacts
...
class NFLContactDetector:
    ...
    def visualize_contacts(self,
        ...
        if len(contacts_df) > 0:
            frame_contacts = contacts_df[contacts_df['time'] == contact_time]
        else:
            frame_contacts = pd.DataFrame()
    ...
    def _draw_field(self, ax):
        ...
        ax.set_title(
            'Player Positions & Contact Detection',
